...
const pandaDimensions = { width: 353 * 1.2, height: 325 * 1.2 };
...
function draw(offset, loopCount) {
  ...
  context.drawImage(
    image,
    -pandaDimensions.width / 2 - offset / 2 + (movementOffset.x * currentPercentage),
    -pandaDimensions.height / 2 - offset / 2 + (movementOffset.y * currentPercentage),
    pandaDimensions.width + offset,
    pandaDimensions.height + offset,
